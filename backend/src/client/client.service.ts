...
export class ClientService {
    ...
    async create(
        ...
        if (nameExists) {
            throw new ConflictException('Client name already exists in this organization');
        }

        if (slugExists) {
            throw new ConflictException('Client slug already exists in this organization');
        }
    ...
    private async assertOrganizationExists(orgId: string) {
        const organization = await this.organizationRepository.findOrgByOrgId(orgId);
