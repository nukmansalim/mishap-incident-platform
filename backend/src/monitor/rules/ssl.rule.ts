...
import { IncidentSeverity, IncidentType, Monitor, MonitorStatus, MonitorType } from '../../../generated/prisma/client';
    ...
    evaluate(monitor: Monitor, outcome: ProbeOutcome): RuleResult | null {
        ...
        if (outcome.sslValid === false) {
            return {
                ...
                resolves: [IncidentType.DOWN, IncidentType.HIGH_LATENCY, IncidentType.SSL_EXPIRING],
            };
        }
        ...
        if (outcome.sslDaysRemaining != null) {
            ...
            if (isCritical || isWarning) {
                return {
                    ...
                    resolves: [IncidentType.DOWN, IncidentType.HIGH_LATENCY, IncidentType.SSL_INVALID],
                };
            }
        }
