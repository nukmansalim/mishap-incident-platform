...
import { MonitorStatus, IncidentStatus, MonitorEventType } from '../../generated/prisma/client';
            ...
            await this.prisma.$transaction(async (tx) => {
                ...
                await tx.monitor.update({
                    ...
                    data: {
                        ...
                        consecutiveLatencyBreaches: evaluation.nextCounters.consecutiveLatencyBreaches,
                    },
                });
                ...
                if (evaluation.openIncident) {
                    ...
                    if (!existingIncident) {
                        ...
                        this.logger.warn(`🚨 INSIDEN BARU: ${evaluation.openIncident.title}`);
                    }
                }
            });
        } catch (error: any) {
            this.logger.error(`Gagal menyimpan state untuk monitor ${monitorId}: ${error.message}`);
            throw error;
        }
    }
}